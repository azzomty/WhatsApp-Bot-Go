...
# It starts at `if strings.HasPrefix(text, ".اغنية") || strings.HasPrefix(text, ".أغنية") {`
# and ends when the block closes. Since regex for nested blocks is hard, I will just extract using string methods.
