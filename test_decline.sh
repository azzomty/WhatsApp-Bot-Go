...
echo -e "\nDeclining at step 9:"
curl -k -s -X POST "https://srv17.akinator.com:9641/game/sessions/$SESSION/decline-toplist" -F "queue_prio=0" -F "step=9" -H "User-Agent: okhttp/5.4.0" -H "Accept: application/json"
